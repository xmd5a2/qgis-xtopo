...
#    if n.lower().endswith('поляна'): n = re.sub("поляна$","пол.", n, flags=re.IGNORECASE)
    ...
    elif n.lower().startswith('новая') and " " in n: n = re.sub("новая","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().startswith('новый') and " " in n: n = re.sub("новый","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().startswith('новые') and " " in n: n = re.sub("новые","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().startswith('новое') and " " in n: n = re.sub("новое","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().endswith('новая') and " " in n: n = re.sub("новая","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().endswith('новый') and " " in n: n = re.sub("новый","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().endswith('новые') and " " in n: n = re.sub("новые","Нов.", n, flags=re.IGNORECASE)
    elif n.lower().endswith('новое') and " " in n: n = re.sub("новое","Нов.", n, flags=re.IGNORECASE)
