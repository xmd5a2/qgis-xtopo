...
def format_place_name(name, population, name_pref_suf_lang, feature, parent):
    ...
    elif "большие" in n.lower() and " " in n: n = re.sub("большие","Бол.", n, flags=re.IGNORECASE)
    elif "большое" in n.lower() and " " in n: n = re.sub("большое","Бол.", n, flags=re.IGNORECASE)
