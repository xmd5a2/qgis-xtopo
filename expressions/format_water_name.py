...
def format_water_name(name, feature, parent):
    ...
    elif "новая" in n.lower() and " " in n: n = re.sub("^новая","Нов.",n, flags=re.IGNORECASE)
    elif "новый" in n.lower() and " " in n: n = re.sub("^новый","Нов.",n, flags=re.IGNORECASE)
    elif "новые" in n.lower() and " " in n: n = re.sub("^новые","Нов.",n, flags=re.IGNORECASE)
    elif "новое" in n.lower() and " " in n: n = re.sub("^новое","Нов.",n, flags=re.IGNORECASE)
    ...
    elif "черное" in n.lower() and " " in n: n = re.sub("черное","Чёрн.",n, flags=re.IGNORECASE)
    elif "чёрное" in n.lower() and " " in n: n = re.sub("чёрное","Чёрн.",n, flags=re.IGNORECASE)
    elif "черная" in n.lower() and " " in n: n = re.sub("черная","Чёрн.",n, flags=re.IGNORECASE)
    elif "чёрная" in n.lower() and " " in n: n = re.sub("чёрная","Чёрн.",n, flags=re.IGNORECASE)
    elif "черный" in n.lower() and " " in n: n = re.sub("черный","Чёрн.",n, flags=re.IGNORECASE)
    elif "чёрный" in n.lower() and " " in n: n = re.sub("чёрный","Чёрн.",n, flags=re.IGNORECASE)
    elif "черные" in n.lower() and " " in n: n = re.sub("черные","Чёрн.",n, flags=re.IGNORECASE)
    elif "чёрные" in n.lower() and " " in n: n = re.sub("чёрные","Чёрн.",n, flags=re.IGNORECASE)
    elif "белая" in n.lower() and " " in n: n = re.sub("белая","Бел.",n, flags=re.IGNORECASE)
    elif "белый" in n.lower() and " " in n: n = re.sub("белый","Бел.",n, flags=re.IGNORECASE)
    elif "белые" in n.lower() and " " in n: n = re.sub("белые","Бел.",n, flags=re.IGNORECASE)
    elif "белое" in n.lower() and " " in n: n = re.sub("белое","Бел.",n, flags=re.IGNORECASE)
