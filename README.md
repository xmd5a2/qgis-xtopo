         ...
         1. **Рельеф**
            1. **Изолинии высот (изогипсы)**
               ...
               * На ледниках: *[TERRAIN] isolines glacier*
                 ...
                 * 25: *25, 75, 125, 175* и т.п., исключая *50, 100, 1000*. **Не сочетается с подслоем 200**.
